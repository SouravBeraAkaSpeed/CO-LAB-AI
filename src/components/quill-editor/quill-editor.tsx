"use client";
import { appWorkspacesType, useAppState } from "@/lib/providers/state-provider";
...
const QuillEditor: React.FC<QuillEditorProps> = ({
  ...
  useEffect(() => {
    if (!fileId) return;
    let selectedDir: Partial<appWorkspacesType>[];
    const fetchInformation = async () => {
      if (dirType === "file") {
        ...
        console.log("data: ", selectedDir[0].data);
  ...
  useEffect(() => {
    ...
    const subscription = room
      .on("presence", { event: "sync" }, () => {
        ...
        console.log("new flatted state: ", newCollaborators);
